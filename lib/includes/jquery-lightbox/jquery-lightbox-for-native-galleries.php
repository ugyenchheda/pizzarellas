...
if ( !is_admin() ) {
			wp_enqueue_script( 'colorbox', KAYA_DIRECTORY.'/lib/includes/jquery-lightbox/colorbox/jquery.colorbox-min.js', array( 'jquery' ), '1.3.14' );

			wp_register_style( 'colorbox-theme1',  KAYA_DIRECTORY.'/lib/includes/jquery-lightbox/colorbox/theme1/colorbox.css', array(), '1.3.14', 'screen' );
			wp_register_style( 'colorbox-theme2', KAYA_DIRECTORY.'/lib/includes/jquery-lightbox/colorbox/theme2/colorbox.css', array(), '1.3.14', 'screen' );
			wp_register_style( 'colorbox-theme3', KAYA_DIRECTORY.'/lib/includes/jquery-lightbox/colorbox/theme3/colorbox.css', array(), '1.3.14', 'screen' );
			wp_register_style( 'colorbox-theme4', KAYA_DIRECTORY.'/lib/includes/jquery-lightbox/colorbox/theme4/colorbox.css', array(), '1.3.14', 'screen' );
			wp_register_style( 'colorbox-theme5', KAYA_DIRECTORY.'/lib/includes/jquery-lightbox/colorbox/theme5/colorbox.css', array(), '1.3.14', 'screen' );
		}
...
?>
	...
	<p class="submit">
		<input type="submit" name="viper-jquery-lightbox-submit" class="button-primary" value="<?php _e('Save Changes','cooks') ?>" />
	</p>
